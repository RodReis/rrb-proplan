...
/** Origem da resolução na escada do ADR-014. 'inference' = nível 3 (Fatia 7). */
export type Source = 'convention' | 'alias' | 'config' | 'inference' | 'absent';
...
export interface Resolution {
  ...
  paths: string[];
  /** 1.0 convenção · 0.8 alias · 1.0 config · inferido varia · 0 ausente. */
  confidence: number;
}
