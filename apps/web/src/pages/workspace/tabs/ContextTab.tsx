        ...
        <div className="flex items-start justify-between gap-4">
          ...
          {!formOpen && !busy && (
            <button
              ...
              className="shrink-0 rounded-md bg-btnbg px-3.5 py-2 text-xs font-semibold text-btnfg transition-all duration-150 hover:bg-btnbg/90 hover:shadow-sm active:scale-[0.97]"
            >
              Registrar asserção
            </button>
          )}
            ...
            >
              ...
              <div className="mt-4 flex items-center gap-2 border-t border-border pt-4">
                <button
                  ...
                  className="rounded-md bg-btnbg px-3.5 py-2 text-xs font-semibold text-btnfg transition-all duration-150 hover:bg-btnbg/90 hover:shadow-sm active:scale-[0.97] disabled:pointer-events-none disabled:opacity-40"
                >
            ...
            <div className="grid md:grid-cols-[1fr_auto]">
              ...
              <div className="flex flex-col justify-center p-7">
                ...
                <div className="mt-5 flex items-center gap-3">
                  <button
                    onClick={() => setFormOpen(true)}
                    className="whitespace-nowrap rounded-md bg-btnbg px-4 py-2 text-xs font-semibold text-btnfg transition-all duration-150 hover:bg-btnbg/90 hover:shadow-sm active:scale-[0.97]"
                  >
