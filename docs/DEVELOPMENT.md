...
4. `a-fazer` — Gate do **teto rígido** no ponto de **enfileiramento** (listener de `DocsSynced` + endpoints de regenerar/bootstrap) — barrar antes de gastar, não dentro do client. Sem "forçar mesmo assim". **(PR 2)**
